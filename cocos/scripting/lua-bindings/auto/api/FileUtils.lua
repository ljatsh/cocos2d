...
-- since v2.1
-- @function setFilenameLookupDictionary 
-- @param self
...
-- js NA<br>
-- lua NA
-- @function listFilesRecursivelyAsync 
-- @param self
...
-- @function setDefaultResourceRootPath 
-- @param self
-- @param #string path
-- @return FileUtils#FileUtils self (return value: cc.FileUtils)
