...
--------------------------------
-- @module Widget
-- @see ProtectedNode,LayoutParameterProtocol
-- @see ccui

--------------------------------
-- Toggle layout component enable.<br>
-- param enable Layout Component of a widget
-- @function setLayoutComponentEnabled 
-- @param self
-- @param #bool enable
...
-- since v3.3
-- @function setPropagateTouchEvents 
-- @param self
...
-- @function isIgnoreContentAdaptWithSize 
-- @param self
-- @return bool#bool ret (return value: bool)
...
-- @function getTouchBeganPosition 
-- @param self
-- @return vec2_table#vec2_table ret (return value: vec2_table)
...
-- since v3.3
-- @function isPropagateTouchEvents 
-- @param self
-- @return bool#bool ret (return value: bool)
...
-- @function isLayoutComponentEnabled 
-- @param self
-- @return bool#bool ret (return value: bool)
...
-- @function isClippingParentContainsPoint 
-- @param self
-- @param #vec2_table pt
-- @return bool#bool ret (return value: bool)
...
-- @function getCurrentFocusedWidget 
-- @param self
-- @return Widget#Widget ret (return value: ccui.Widget)
