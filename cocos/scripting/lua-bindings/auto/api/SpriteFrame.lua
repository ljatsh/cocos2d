...
-- @function setCenterRectInPixels 
-- @param self
...
-- @function initWithTextureFilename
-- @param self
...
-- @function setOriginalSizeInPixels 
-- @param self
-- @param #size_table sizeInPixels
-- @return SpriteFrame#SpriteFrame self (return value: cc.SpriteFrame)
