...
-- @function setPostUpdateCallback 
-- @param self
-- @param #function callback
-- @return PhysicsWorld#PhysicsWorld self (return value: cc.PhysicsWorld)
