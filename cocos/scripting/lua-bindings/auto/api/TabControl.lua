...
-- @function ignoreHeadersTextureSize 
-- @param self
-- @param #bool ignore
-- @return TabControl#TabControl self (return value: ccui.TabControl)
...
-- @function isIgnoreHeadersTextureSize 
-- @param self
...
-- @function setTabChangedEventListener 
-- @param self
...
-- @function setHeaderSelectedZoom 
-- @param self
-- @param #float zoom
-- @return TabControl#TabControl self (return value: ccui.TabControl)
...
-- @function getHeaderSelectedZoom 
-- @param self
-- @return float#float ret (return value: float)
