...
-- @function setDisplayFrameWithAnimationName 
-- @param self
...
-- @function setCenterRectNormalized 
-- @param self
...
-- @function getCenterRectNormalized 
-- @param self
-- @return rect_table#rect_table ret (return value: rect_table)
