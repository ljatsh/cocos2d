...
-- @function getVertexAttribsFlags 
-- @param self
...
-- @function setParameterAutoBinding 
-- @param self
-- @param #string uniformName
-- @param #string autoBinding
-- @return GLProgramState#GLProgramState self (return value: cc.GLProgramState)
...
-- @function getOrCreateWithGLProgramName
-- @param self
...
-- @function getOrCreateWithGLProgram 
-- @param self
-- @param #cc.GLProgram glprogram
-- @return GLProgramState#GLProgramState ret (return value: cc.GLProgramState)
...
-- @function getOrCreateWithShaders 
-- @param self
