...
int lua_cocos2dx_fairygui_GObject_setName(lua_State* tolua_S)
{
	int argc = 0;
	...
	if (!cobj)
	{
		tolua_error(tolua_S, "invalid 'cobj' in function 'lua_cocos2dx_fairygui_GObject_setName'", nullptr);
		return 0;
	}
#endif
	...
	{
    std::string name;
		ok &= luaval_to_std_string(tolua_S, 2, &name, "lua_cocos2dx_fairygui_GObject_setName");
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'lua_cocos2dx_fairygui_GObject_setName'", nullptr);
			return 0;
		}
...
static void extendGObject(lua_State* L)
{
    ...
    tolua_function(L, "setName", lua_cocos2dx_fairygui_GObject_setName);
	}
	lua_pop(L, 1);
}
